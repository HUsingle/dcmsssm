...
public class TeacherController {
    ...
    public String updateSelfTeacher(@RequestParam("id") String id, @RequestParam("name") String name,
                                    ...
                                    @RequestParam("phone") String phone, @RequestParam("email") String email,
                                    @RequestParam("sex") String sex, @RequestParam("password") String password, HttpServletRequest request) {
        return teacherService.updateSelfTeacher(id, name, college, phone, email, sex, password,request);
    ...
    public String isExistPhone(String phone) {
        return teacherService.isExistPhone(phone);
    }
